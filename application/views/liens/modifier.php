<div>
	<form action="<?=site_url("green/script_modifier")?>" method="POST" class="form-group">
		...
		<input name="Prix_Achat_Fournisseur" class="form-control" type="text" value="<?=$liste->Prix_Achat_Fournisseur?>" />
		<label>Prix vente HT : </label>
		<input name="Prix_HT_Produit" class="form-control" type="text" value="<?=$liste->Prix_HT_Produit?>" />
	    <label>Stock : </label>
		<input name="Stock_Produit" class="form-control" type="text" value="<?=$liste->Stock_Produit?>" />
